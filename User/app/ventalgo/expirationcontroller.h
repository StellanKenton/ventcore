...
#define EXPIRATION_CONTROLLER_CAPTURE_VALVE_CORRECTION_SCALE   60.0F

/* Pressure-position feedforward. The expiratory valve is the fast braking actuator. */
...
#define EXPIRATION_CONTROLLER_CAPTURE_VALVE_STEP_GAIN           0.30F
