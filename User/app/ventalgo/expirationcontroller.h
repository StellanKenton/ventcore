...
#define EXPIRATION_CONTROLLER_RELEASE_VALVE_OUTER_KP          1.0F
#define EXPIRATION_CONTROLLER_RELEASE_VALVE_OUTER_KI          0.0F
#define EXPIRATION_CONTROLLER_RELEASE_VALVE_OUTER_KD          0.0F
#define EXPIRATION_CONTROLLER_RELEASE_VALVE_TARGET_MIN      (-40.0F)
#define EXPIRATION_CONTROLLER_RELEASE_VALVE_TARGET_MAX       40.0F
#define EXPIRATION_CONTROLLER_RELEASE_VALVE_INNER_KP          0.25F
#define EXPIRATION_CONTROLLER_RELEASE_VALVE_INNER_KI          0.0F
#define EXPIRATION_CONTROLLER_RELEASE_VALVE_INNER_KD          0.0F
#define EXPIRATION_CONTROLLER_RELEASE_VALVE_EFFORT_MIN      (-1.0F)
#define EXPIRATION_CONTROLLER_RELEASE_VALVE_EFFORT_MAX        1.0F
#define EXPIRATION_CONTROLLER_RELEASE_VALVE_EFFORT_SCALE     50.0F
...
#define EXPIRATION_CONTROLLER_PEEP_RELIEF_GAIN             20.0F
...
#define EXPIRATION_CONTROLLER_RELEASE_VALVE_DUTY            50U
...
#define EXPIRATION_CONTROLLER_PEEP_ENTRY_RAMP_TIME_MS      160.0F
