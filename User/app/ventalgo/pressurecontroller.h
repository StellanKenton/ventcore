...
#define PRESSURE_CONTROLLER_OUTER_CORRECTION_MIN    (-20.0F)
#define PRESSURE_CONTROLLER_OUTER_CORRECTION_MAX     20.0F

#define PRESSURE_CONTROLLER_INNER_KP                 5.0F
#define PRESSURE_CONTROLLER_INNER_KI                 6.0F
...
#define PRESSURE_CONTROLLER_PEEP_FEEDFORWARD          22.5F
#define PRESSURE_CONTROLLER_PEEP_SPIN_BLOWER_TARGET   3000U
#define PRESSURE_CONTROLLER_INSP_FEEDFORWARD          35.0F
#define PRESSURE_CONTROLLER_RISE_BOOST_BLOWER_TARGET  5000U
#define PRESSURE_CONTROLLER_RISE_BOOST_EXIT_MARGIN    2.0F
