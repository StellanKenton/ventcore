...
#define PRESSURE_CONTROLLER_OUTER_CORRECTION_MIN    (-3.0F)
#define PRESSURE_CONTROLLER_OUTER_CORRECTION_MAX     3.0F
...
#define PRESSURE_CONTROLLER_RISE_FAST_REF_BLEND        1.00F
...
#define PRESSURE_CONTROLLER_HOLD_RELIEF_DEADBAND      0.1F
#define PRESSURE_CONTROLLER_HOLD_RELIEF_GAIN          5.0F
#define PRESSURE_CONTROLLER_HOLD_RELIEF_MAX_OPENING  10.0F
#define PRESSURE_CONTROLLER_HOLD_SLOPE_FILTER_GAIN     0.20F
#define PRESSURE_CONTROLLER_HOLD_FALL_SLOPE_THRESHOLD (-2.0F)
#define PRESSURE_CONTROLLER_HOLD_FF_PEEP_START_CMH2O  10.0F
#define PRESSURE_CONTROLLER_HOLD_FF_PEEP_GAIN           5.0F
#define PRESSURE_CONTROLLER_HOLD_FF_PEEP_MAX           75.0F
