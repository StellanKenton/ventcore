...
int main(void) {
    ...
    send(0xAF, 0x15, 85, 1, 1);
    assert(GetVentPSimvSettings()->SIMVRateBpm == 8.5F);
    assert(GetVentVSimvSettings()->SIMVRateBpm == 8.5F);
    assert(GetVentVSimvSettings()->tidalVolumeMl == 650.0F);
    assert(GetVentPrvcSettings()->targetTidalVolumeMl == 650.0F);
    assert(GetVentPrvcSettings()->respiratoryRateBpm == 20.0F);
    assert(GetVentPrvcSettings()->inspiratoryTimeMs == 1250U);
    assert(GetVentPrvcSettings()->pressureTriggerCmh2o == -2.0F);
    assert(GetVentPrvcSettings()->oxygenPercent == GetVentVacSettings()->oxygen);
    assert(GetVentPrvcSettings()->peepCmh2o == GetVentVacSettings()->peep);
    assert(GetVentPrvcSettings()->triggerType == GetVentVacSettings()->triggerType);
    assert(GetVentPrvcSettings()->flowTriggerLpm == GetVentVacSettings()->flowTriggerLpm);
    assert(GetVentPrvcSimvSettings()->SIMVRateBpm == 8.5F);
    assert(GetVentPrvcSimvSettings()->targetTidalVolumeMl == 650.0F);
    assert(GetVentPrvcSimvSettings()->inspiratoryTimeMs == 1250U);
    assert(GetVentPrvcSimvSettings()->pressureTriggerCmh2o == -2.0F);
    assert(GetVentPrvcSimvSettings()->oxygenPercent == GetVentVSimvSettings()->oxygenPercent);
    assert(GetVentPrvcSimvSettings()->peepCmh2o == GetVentVSimvSettings()->peepCmh2o);
    assert(GetVentPrvcSimvSettings()->triggerType == GetVentVSimvSettings()->triggerType);
    assert(GetVentPrvcSimvSettings()->flowTriggerLpm == GetVentVSimvSettings()->flowTriggerLpm);
    send(0xAF, 0x09, 125, 2, 1);
    send(0xAF, 0x13, 35, 1, 0);
    assert(GetVentPrvcSimvSettings()->supportPressureCmh2o == 12.5F);
    assert(GetVentPrvcSimvSettings()->cycleOffPercent == 35.0F);
    assert(GetVentVsSettings()->cycleOffPercent == 35.0F);
    assert(GetVentVsSettings()->targetTidalVolumeMl == 650.0F);
    assert(GetVentVsSettings()->pressureTriggerCmh2o == -2.0F);
    assert(GetVentVsSettings()->peepCmh2o == GetVentPrvcSimvSettings()->peepCmh2o);
    assert(GetVentVsSettings()->apneaAlarmTimeMs == 15000U);
    send(0xAF, 0x1A, 25, 2, 2);
    assert(GetVentVsSettings()->riseTimeMs == 250U);
    send(0xAF, 0x0A, 25, 1, 0); send(0xAF, 0x0B, 7, 1, 0);
    send(0xAF, 0x1B, 25, 2, 1); send(0xAF, 0x1C, 35, 2, 1);
    assert(GetVentBapapSettings()->pressureHighCmh2o == 25.0F);
    assert(GetVentAprvSettings()->pressureHighCmh2o == 25.0F);
    assert(GetVentBapapSettings()->pressureLowCmh2o == 7.0F);
    assert(GetVentAprvSettings()->pressureLowCmh2o == 7.0F);
    assert(GetVentBapapSettings()->timeHighMs == 2500U && GetVentBapapSettings()->timeLowMs == 3500U);
    assert(GetVentAprvSettings()->timeHighMs == 2500U && GetVentAprvSettings()->timeLowMs == 3500U);
    assert(GetVentBapapSettings()->riseTimeMs == 250U);
    assert(GetVentAprvSettings()->riseTimeMs == 250U);
    assert(GetVentBapapSettings()->pressureSupportCmh2o == 12.5F);
    assert(GetVentBapapSettings()->cycleOffPercent == 35.0F);
    assert(GetVentBapapSettings()->maxInspiratoryTimeMs == 1800U);
    assert(GetVentPSimvSettings()->inspiratoryTimeMs == 1250U);
    assert(GetVentVSimvSettings()->pressureTriggerCmh2o == -2.0F);
    send(0xAF, 0x0F, 450, 2, 0);
    assert(GetVentVSimvSettings()->apneaVolumeTidalMl == 450.0F);
    assert(GetVentPrvcSimvSettings()->apneaVolumeTidalMl == 450.0F);
    assert(GetVentPrvcSimvSettings()->apneaPressureCmh2o == 23.0F);
    assert(GetVentPrvcSimvSettings()->apneaRateBpm == 12.0F);
    assert(GetVentPrvcSimvSettings()->apneaInspTimeMs == 1500U);
    assert(GetVentVsSettings()->apneaInspTimeMs == 1500U);
    assert(GetVentVsSettings()->apneaRateBpm == 12.0F);
    assert(GetVentVsSettings()->apneaPressureCmh2o == 23.0F);
    assert(GetVentVsSettings()->apneaVolumeTidalMl == 450.0F);
    assert(GetVentPSimvSettings()->apneaPressureCmh2o == 23.0F);
    send(0xAE, 0x0A, 1, 1, 0);
    assert(GetVentPSimvSettings()->apneaSwitch == VENT_APNEA_PRESSURE && GetVentVSimvSettings()->apneaSwitch == VENT_APNEA_PRESSURE);
    assert(GetVentPrvcSimvSettings()->apneaSwitch == VENT_APNEA_PRESSURE);
    assert(GetVentVsSettings()->apneaSwitch == VENT_APNEA_PRESSURE);
    assert(GetVentBapapSettings()->apneaSwitch == VENT_APNEA_PRESSURE);
    assert(GetVentAprvSettings()->apneaSwitch == VENT_APNEA_PRESSURE);
    send(0xAE, 0x0A, 2, 1, 0);
    assert(GetVentPSimvSettings()->apneaSwitch == VENT_APNEA_VOLUME && GetVentVSimvSettings()->apneaSwitch == VENT_APNEA_VOLUME);
    assert(GetVentPrvcSimvSettings()->apneaSwitch == VENT_APNEA_VOLUME);
    assert(GetVentVsSettings()->apneaSwitch == VENT_APNEA_VOLUME);
    assert(GetVentBapapSettings()->apneaSwitch == VENT_APNEA_VOLUME);
    assert(GetVentAprvSettings()->apneaSwitch == VENT_APNEA_VOLUME);
    send(0xAE, 0x0A, 0, 1, 0);
    assert(GetVentPSimvSettings()->apneaSwitch == VENT_APNEA_OFF && GetVentVSimvSettings()->apneaSwitch == VENT_APNEA_OFF);
    assert(GetVentPrvcSimvSettings()->apneaSwitch == VENT_APNEA_OFF);
    assert(GetVentVsSettings()->apneaSwitch == VENT_APNEA_OFF);
    assert(GetVentBapapSettings()->apneaSwitch == VENT_APNEA_OFF);
    assert(GetVentAprvSettings()->apneaSwitch == VENT_APNEA_OFF);
