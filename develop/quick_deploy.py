...
COMMAND_PREFIX = "Vent Net"
DEVICE_TOOL_PATH = "${workspaceFolder}/develop/quick_deploy.py"
...
def deploy(computer: Optional[str]) -> None:
    ...
    workspace_commands[f"{COMMAND_PREFIX} Build"] = command(
        ...
        "tools",
        420,
        "Build firmware with develop/device_tool.py in the integrated terminal.",
    )
    ...
    if "usernamehw.commands" not in recommendations:
        recommendations.append("usernamehw.commands")
